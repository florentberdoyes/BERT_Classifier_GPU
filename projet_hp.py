...
Original file is located at
    https://colab.research.google.com/drive/12-CkSnnmG65CiWtHUAXe3mDoLAsraPhH
...
plt.plot(range(0, 200, 20), tab_model_gpu, label="Model")
plt.plot(range(0, 200, 20), tab_quantized_model_gpu, label="Quantized Model")
plt.plot(range(0, 200, 20), tab_model_pruned_gpu, label="Pruned Model")
plt.plot(range(0, 200, 20), tab_quantized_model_pruned_gpu, label="Quantized + Pruned")
plt.legend()
...
plt.plot(range(0, 200, 20), tab_model_cpu, label="Model CPU")
plt.plot(range(0, 200, 20), tab_model_gpu, label="Model GPU")
plt.legend()
